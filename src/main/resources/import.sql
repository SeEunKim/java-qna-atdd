INSERT INTO user (id, user_id, password, name, email, created_at) values (1, 'javajigi', 'password', '자바지기', 'javajigi@slipp.net', CURRENT_TIMESTAMP());
INSERT INTO user (id, user_id, password, name, email, created_at) values (2, 'sanjigi', 'password', '산지기', 'sanjigi@slipp.net', CURRENT_TIMESTAMP());
INSERT INTO user (id, user_id, password, name, email, created_at) values (3, 'red', '1', 'red', 'red@gmail.com', CURRENT_TIMESTAMP());
INSERT INTO user (id, user_id, password, name, email, created_at) values (4, 'unhee', '1', 'unhee', 'unhee@gmail.com', CURRENT_TIMESTAMP());
...
INSERT INTO question (id, writer_id, title, contents, created_at, deleted) VALUES (3, 1, 'title', 'contents', CURRENT_TIMESTAMP(), false);